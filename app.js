...
const previewDefinitions = {
  ...
  test: {
    title: 'Тест',
    kind: 'paper',
    tag: '8 сынып • Биология',
    headline: 'Қанның құрамы',
    blocks: ['5 тест сұрағы', 'Деңгейлік тапсырмалар', 'Сәйкестендіру', 'Бонус тапсырма'],
    image: '/assets/previews/test.jpeg'
  },

  bjb: {
    title: 'БЖБ',
    kind: 'paper',
    tag: '8 сынып • 2 тоқсан',
    headline: 'Бөлім бойынша жиынтық бағалау',
    blocks: ['Оқу мақсаттары', '4–6 тапсырма', 'Жалпы балл', 'Жауап кілті']
  },

  tjb: {
    title: 'ТЖБ',
    kind: 'paper',
    tag: '9 сынып • 1 тоқсан',
    headline: 'Тоқсан бойынша жиынтық бағалау',
    blocks: ['Спецификация', 'Бөлімдер бойынша тапсырмалар', 'Балл қою кестесі', 'Дескрипторлар']
  },

  presentation: {
    title: 'Презентация',
    kind: 'slides',
    tag: '10 сынып • Информатика',
    headline: 'Жасанды интеллект',
    blocks: ['Оқу мақсаты', 'Жаңа тақырып', 'Практика', 'Рефлексия']
  },

  worksheet: {
    title: 'Жұмыс парағы',
    kind: 'worksheet',
    tag: '7 сынып • Информатика',
    headline: 'Компьютерлік желілер',
    blocks: ['Ассоциация', 'Суретпен жұмыс', 'Сәйкестендіру', 'Ойын элементі'],
    image: '/assets/previews/worksheet.jpeg'
  },
  ...
  poster: {
    ...
    tag: '8 сынып • Биология',
    headline: 'Қанның құрамы',
    blocks: ['Бұл не?', 'Неліктен маңызды?', 'Білесің бе?', 'Есте сақта!'],
    image: '/assets/previews/poster.jpeg'
  },

  infographic: {
    title: 'Инфографика',
    kind: 'infographic',
    tag: '7 сынып • География',
    headline: 'Су айналымы',
    blocks: ['Негізгі визуал', '4–6 блок', 'Кезеңдік схема', 'Есте сақта!'],
    image: '/assets/previews/infographic.jpeg'
  },

  cards: {
    title: 'Карточкалар',
    kind: 'cards',
    tag: '6 сынып • Математика',
    headline: 'Қатынас және пропорция',
    blocks: ['№1', '№2', '№3', '№4', '№5', '№6'],
    image: '/assets/previews/cards.jpeg'
  },
  ...
  lessonPlan: {
    ...
    kind: 'plan',
    tag: '7 сынып • Информатика',
    headline: 'Қысқа мерзімді жоспар',
    blocks: ['Сабақтың басы', 'Сабақтың ортасы', 'Бағалау', 'Рефлексия']
  },

  banner: {
    title: 'Баннер',
    kind: 'banner',
    tag: 'Онлайн практикум',
    headline: 'ЖИ-ПРАКТИКУМ',
    blocks: ['05.09.2026', '19:00', '2 000 ₸', 'ТІРКЕЛУ'],
    image: '/assets/previews/banner.jpeg'
  }
